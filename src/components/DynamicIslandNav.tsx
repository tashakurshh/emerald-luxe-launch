          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`relative flex items-center gap-1.5 px-3 py-2 rounded-full transition-all duration-180 ease-ios-spring ${
              ...
              >
                ...
                <span
                  className={`text-sm font-medium transition-all duration-200 ease-ios-spring overflow-hidden relative z-10 ${
